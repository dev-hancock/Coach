...
namespace Coach.Application.Features.TrainingPlans.ScheduleSession;
...
/// </summary>
internal sealed class ScheduleSessionHandler(IRepository<TrainingPlan> plans) : IRequestHandler<ScheduleSessionRequest, ScheduleSessionResponse>
{
