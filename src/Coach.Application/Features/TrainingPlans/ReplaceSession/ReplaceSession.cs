...
namespace Coach.Application.Features.TrainingPlans.ReplaceSession;
...
/// </summary>
internal sealed class ReplaceSessionHandler(IRepository<TrainingPlan> plans) : IRequestHandler<ReplaceSessionRequest>
{
