...
namespace Coach.Application.Features.Health.AddHealthEntry;
...
/// </summary>
internal sealed class AddHealthEntryHandler(IRepository<HealthEntry> repository) : IRequestHandler<AddHealthEntryRequest, AddHealthEntryResponse>
{
